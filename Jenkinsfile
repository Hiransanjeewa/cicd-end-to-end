pipeline {
    ...
    stages {
        ...
        stage('Update K8S manifest & push to Repo') {
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: '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', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                        sh '''
                        cat deploy.yaml
                        ls
                        pwd
                        ...
                        git remote -v
                        git push https://hiransanjeewa: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@github.com/hiransanjeewa/Audiohub-Kubernetes-manifest.git HEAD:main
